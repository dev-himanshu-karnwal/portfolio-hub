...
export function ActiveFilterChips({
  ...
  filters.visibility.forEach((v) => chips.push({ kind: 'visibility', label: v, value: v }))

  if (chips.length === 0) return null

  return (
    <div className="mt-2.5 flex flex-wrap items-center gap-2 rounded-xl border border-line/60 bg-surface/80 px-3 py-2">
